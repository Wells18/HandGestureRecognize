...
def SetupInitial():
    ...
    return [data2a,data4a,data3a,data1a,data5a,data5b,data6a,data2b,data3b,data1b,data6b,data2c,data3c,data1c,data6c,data2d,data3d,data1d,data6d,data7a,data7b,data8a,data8b,data9a,data10a,data10b,data11a,data11b,data11c]
...
def ReadStageInitial(stageNoforChange,FGInfoIni,FGCIni,BGInfoIni,BGCIni,CUSInfoIni,CUSCIni,OBJInfoIni,OBJCIni,GoodyIni,BodyPosIni,LogDirIni,ScriptIni,firstTimeIni,previousStage):
